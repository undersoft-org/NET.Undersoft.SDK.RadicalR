...
namespace RadicalR
{
    public class CommandSetValidator<TDto> : CommandSetValidatorBase<CommandSet<TDto>> where TDto : Dto
    {
        ...
        protected void ValidateLength(int min, int max, params Expression<Func<Command<TDto>, object>>[] members)
        {
        ...
        protected void ValidateCount(int min, int max, params Expression<Func<Command<TDto>, object>>[] members)
        {
            members.ForEach((member) =>
            {
                RuleForEach(v => v)
